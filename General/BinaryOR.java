public class BinaryOR {
    ...
    // Function to perform OR on two binary strings
    private static String binaryOR(String binary1, String binary2) {
    ...
    public static void main(String[] args) {
        ...
        String result = binaryOR(binaryString1, binaryString2);

        System.out.println("Binary OR Result: " + result);
    }
}
